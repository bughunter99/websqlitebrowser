...
urlpatterns = [
    ...
    path('api/tree/search/', views.repository_tree_search, name='repository_tree_search'),
    ...
    path('api/file/read/', views.file_read_view, name='file_read'),
    path('api/file/write/', views.file_write_view, name='file_write'),
